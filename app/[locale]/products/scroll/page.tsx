...
export async function generateMetadata({params}: {params: Promise<{locale: string}>}) {
  ...
  return {
    title: `${t('scroll.name')} — DENIXE`,
    description: t('scroll.desc'),
  };
}
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="aspect-[4/3] relative bg-gray-50 rounded-xl border border-gray-200 overflow-hidden">
              <Image
                src="/images/products/wx1-realistic.webp"
                alt={t('imageAlt', {series: t('scroll.name')})}
                fill
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-8">
            {t('scroll.specs.title')} — {t('scroll.specs.table')}
          </h2>
